...
// Check conectividad a BT.
    ...
    if (a2dp_sink.is_connected() == true) {
      ...
      display.clearDisplay();
      display.setCursor(35,0); // Esquina superior izquierda
      display.setTextSize(2);
      display.println("BT ON");
      display.setTextSize(1);
      display.setCursor(0,18); display.print("---------------------");
      display.setCursor(0,25);
      display.print("Volumen: "); display.print(rotaryEncoder.readEncoder()); display.println("%");
